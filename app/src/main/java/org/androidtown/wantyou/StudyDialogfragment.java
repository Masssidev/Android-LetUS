...
public class StudyDialogfragment extends DialogFragment implements Runnable{
    private int id;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setNegativeButton("검색", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Thread th = new Thread(StudyDialogfragment.this);
                th.start();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    Intent resultIntent = new Intent(getContext(), ResultStudyActivity.class);
