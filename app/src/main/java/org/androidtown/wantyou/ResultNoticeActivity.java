...
public class ResultNoticeActivity extends AppCompatActivity implements Runnable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent selectIntent = new Intent(ResultNoticeActivity.this, SelectedFairActivity.class);
                selectIntent.putExtra("id", data.getId());
                ResultNoticeActivity.this.startActivity(selectIntent);
            }
        });
    ...
    protected void onResume() {
        ...
        Thread thread = new Thread(ResultNoticeActivity.this);
        thread.start();
        try {
            thread.join();
