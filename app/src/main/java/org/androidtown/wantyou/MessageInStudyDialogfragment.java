...
public class MessageInStudyDialogfragment extends DialogFragment implements Runnable{
    private String message, success;
    private String domain = "http://172.30.5.56:8080/android/";
    private EditText messageText;
    private SelectedStudyActivity activity;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        activity = (SelectedStudyActivity) getActivity();
        ...
        builder.setNegativeButton("보내기", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Thread th = new Thread(MessageInStudyDialogfragment.this);
                th.start();
            }
        });
