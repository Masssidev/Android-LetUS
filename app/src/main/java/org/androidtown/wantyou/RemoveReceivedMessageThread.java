...
public class RemoveReceivedMessageThread extends Thread{
    private Context context;
    private int id;
    private String message;
    private String domain = "http://172.30.5.56:8080/android/";

    public RemoveReceivedMessageThread(Context context, int id) {
    ...
    public void run() {
        ...
        String url = domain+"removeReceivedMessage";
